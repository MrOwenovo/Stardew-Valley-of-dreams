...
Custom NPC Fixes: 自定义NPC修复(修复了自定义位置的 NPC 生成、自定义位置的路径以及新 NPC 的时间表)
Dynamic Game Assets: 动态游戏资产(允许内容包向游戏添加自定义内容)
Custom Music: 自定义音乐
...
UI Info Suite2: 显示UI √
Visible Fish: 显示可钓的鱼 ×
卢米斯特里亚瓷砖板 - 室内&室外(室内室外新瓦片): [CP] Lumisteria  ×
Tilesheets - Indoor& Outdoor
owo表情: OwOEmote ×
...
ExpandedFridge: 迷你冰箱 ×
Binning Skill: 垃圾桶搜索  √
Better Friendship: 更好的友谊 ×
Magic: 魔法  √
Turn to your enemies: 转向你的敌人 ×
